        ...
        <div className="row checkout-header">
          ...
          <div className="address col-md-6 p-2">
            ...
            <form className="row g-3 mb-3">
              ...
              <div className="col-12">
                <label htmlFor="inputAddress2" className="form-label">Địa chỉ 2</label>
                <input type="text" className="form-control" id="inputAddress2" placeholder="Chung cư, công ty, hoặc căn hộ" />
              </div>
              <div className="col-md-6">
              ...
              <div className="col-md-2">
                <label htmlFor="inputZip" className="form-label">Mã bưu điện</label>
                <input type="text" className="form-control" id="inputZip" />
              </div>
              <div className="col-12 mt-5">
                <button id="button-linker" type="submit" onClick={handlePay}>Chấp nhận thanh toán</button>
              </div>
            </form>
          </div>
        </div>
